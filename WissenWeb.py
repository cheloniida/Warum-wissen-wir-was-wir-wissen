...
# Bildpfad, Kategorie, Erklärung
        spiel_bilder = [
            ...
            {"bild": "Bilder_Spiel/gerenuk.jpeg", "kategorie": "A", "erklaerung": "Das ist ein Gerenuk, auch Giraffengazelle (<i>Litocranius sp.</i>) genannt. Sie ist in Westafrika in Tansania, Äthiopien, Somalia und Kenia verbreitet, wo sie trockene Dornenbuschlanschaften bewohnt. Ihre Schulterhöhe beträgt etwa 1 m."},
            {"bild": "Bilder_Spiel/fake_fossil.png", "kategorie": "B", "erklaerung": "Dies ist ein KI Bild einer angeblichen Ausgrabungsstätte. Mal abgesehen davon, dass es keine Einhörner gibt oder so weit wir wissen je gab deutet auch der Rest des Bildes eindeutig auf KI hin: Düsteres, mysteriöses Licht; eine perfekt ausgehobene Grube und ein perfekt geborgene Skelett mit einer daneben liegenden Skala, die man nicht erkennen kann."},
            {"bild": "Bilder_Spiel/fake_squid.png", "kategorie": "B", "erklaerung": 'Dies ist ein KI Bild. Und auch wenn darüber steht: „Diese Foto ist echt und wurde heute aufgenommen" - nein, es ist nicht echt. <br>Warum? <br> 1. Die Körperform deutet zunächst auf einen Kraken d.h. Oktopus hin. Es wurden aber bisher keine Oktopoden gefunden, die diese Größe erreichen. Der größte Oktopus, den wir heute kennen ist der Pazifische Riesenoktopus (<i>Enteroctopus dofleini</i>), der ausgesteckt etwa 5 m lang werden kann, während ein Einzelfall von etwa 9 m berichtet. Hier muss man jedoch beachten, dass der Körper von Oktopoden sehr flexibel und dehnbar ist, aber nicht unendlich viel Masse besitzt. Wenn ein Oktopus seine Arme ausstreckt bis es nicht mehr geht, wird er deshalb unweigerlich immer dünner, während der KI-Krake trotz seiner Länge sehr kompakt aussieht. Auch die extreme Größe des Riesenkalmars (<i>Architeuthis dux</i>) basiert vor allem auf ihren zwei einzelnen verlängerten Tentakeln , durch die die Körperlänge auf bis zu 13 m summiert werden kann. Jedoch ist auf diesem Bild kein Kalmar zu sehen. <br> 2. Was machen die Menschen da im Hintergrund? Warum sind da Leute im Wasser? Sollen das Surfer sein? Warum sind da nicht mehr Menschen…?'},
