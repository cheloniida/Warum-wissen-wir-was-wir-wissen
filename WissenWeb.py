...
# Bildpfad, Kategorie, Erklärung
        spiel_bilder = [
            ...
            {"bild": "Bilder_Spiel/barreleyefish.png", "kategorie": "A", "erklaerung": "Glaskopffisch (<i>Macropinna microstoma</i>). Lebt im nördlichen Pazifik und hat eine Länge von etwa 11 cm."},
