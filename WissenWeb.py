...
# Bildpfad, Kategorie, Erklärung
        spiel_bilder = [
            ...
            {"bild": "Bilder_Spiel/costasiella1.jpg", "kategorie": "A", "erklaerung": "Dieses Foto zeigt ein sogenanntes Blattschaf (<i>Costasiella kuroshimae</i>) Es handelt sich um eine Meeresschnecke, die vor allem  in den Gewässern rund um Japan, Indonesien und den Philippinen gefunden wurde. Da sie jedoch nur zwischen 4 und 10 mm groß ist, wird sie wohl auch häufig übersehen. Die blattartigen Körperanhänge (Cerata) der Schnecke haben zwei Funktionen: 1. Sie vergrößern die Körperoberfläche, was bei Hautatmern wie Schnecken für eine bessere Sauerstoffaufnahme sorgt. 2. Sie bieten Platz um darin unzählige Chloplasten einzulagern, die durch die Ernährung von Algen aufgenommen werden. Die Chloroplasten werden durch die Verdauung nicht zerstört, und können durch die transparente Haut der Schnecke hindurch Licht aufnehmen. So kann die Schecke, obwohl sie ein Tier ist Photosynthese betreiben und kann es sich dadurch leisten weniger zu fressen."},
