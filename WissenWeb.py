...
# Bildpfad, Kategorie, Erklärung
        spiel_bilder = [
            {"bild": "Bilder_Spiel/ayeaye.jpg", "kategorie": "A", "erklaerung": "Dies ist ein Aye Aye (<i>Daubentonia madagascariensis</i>) - auch Fingertier genannt . Es lebt ausschließlich in den Wäldern Madagaskars und ist sehr stark durch Bejagung gefährdet."},
            {"bild": "Bilder_Spiel/barreleyefish.png", "kategorie": "A", "erklaerung": "Das ist ein Glaskopffisch (<i>Macropinna microstoma</i>). Lebt im nördlichen Pazifik und hat eine Länge von etwa 11 cm."},
            {"bild": "Bilder_Spiel/fake_seaserpent.png", "kategorie": "B", "erklaerung": "Das ist ein von KI erstelltes Bild. Das erkennt man z.B. an der Markellosigkeit des Bildes. Oben wird in einer seltsamen Perspektive ein Lichtspiel auf einer Wasseroberfläche imitiert, das jedoch keine Auswirkungen auf das Licht Unterwasser zu haben scheint. Die tauchende Person scheint Atemluft auszustoßen, das Seeungeheuer jedoch nicht. Im Hintergrund wird ein Felsen angedeutet, ansonsten sieht das Ganze jedoch aus, als fände die Szene im offenen Ozean statt.<br> Seeungeheuer wie diese sind in Filmen beheimatet. Doch in der Realität finden wir trotzdem viele Lebewesen, die aussehen als wären sie eine phantastische Erfindung, wie z.B den Großen Riemenfisch (Giant oarfish - <i>Regalecus glesne</i>)."},
            {"bild": "Bilder_Spiel/fake_beetle1.jpg", "kategorie": "B", "erklaerung": "Das ist ein von KI erstelltes Bild. Auch wenn der Käfer sehr realistisch und wie für die Ausstellung eines Museums fotografiert aussieht - wer genau hinschaut erkennt, dass die Deckflügel und der Kopfpanzer dieses Käfers nicht nur Baumrinde imitieren, sondern tatsächlich aus Baumrinde zu bestehen scheinen."},
            {"bild": "Bilder_Spiel/batfish.jpg", "kategorie": "A", "erklaerung": "Das ist ein Fisch, der Rotlippige Seefledermaus (<i>Ogcocephalus darwini</i>) genannt wird. Man findet sie in der Umgebung der Galápagos Inseln. Sie gehören zu der sehr interessanten Ordnung der Armflosser (<i>Lophiiformes</i>) von denen viele tatsächlich mit ihren Flossen über den Meeresboden laufen können. Zudem ist der erste Hartstrahl der Rückenflosse meist zu einer Art 'Angel' umgebildet."},
            {"bild": "Bilder_Spiel/fake_blizzard.png", "kategorie": "B", "erklaerung": "Das ist ein von KI erstelltes Bild. Hier verschluckt eine Schneewehe Häuser mit mindestens 5 Stockwerken und überragt diese noch um viele Meter. Schätzungsweise soll die Schneewehe hier ca 20 bis 40m hoch sein. Solche Verwehungen sind heutzutage nicht realistisch. In urbanen Wohngebieten können starke Schneestürme Straßen und Häuser an manchen Stellen in etwa 5 m hohe Verwehungen hüllen. Verwehungen über 10m sind sehr selten und kommen nur in extrem gelegenen Gebieten vor. Lawinen können höhere Schneedecken erzeugen - die sähen aber anders aus. Interessant ist auch, das keines der Gebäude auf diesem Bild beschädigt ist…"},
            {"bild": "Bilder_Spiel/fake_jupiter.png", "kategorie": "B", "erklaerung": "Das ist ein von KI erstelltes Bild. Es gibt viele echt Aufnahmen von Jupiter. Es wurden Aufnahmen im Vorbeiflug gemacht - das erste 1973 von der Pioneer 10, dann u.a. von den Voyager Sonden und zuletzt von Juno. Auch Teleskope und Weltraumteleskop machen Bilder von Jupiter wie z.B Hubble oder James Webb. Manchmal kann man darauf auch die Monde des Jupiter erkennen. Auf manchen Aufnahmen, die unter besonderen Bedingungen gemacht wurden, erkennt man auch den fast unsichtbaren Staubring der Jupiter umgibt. Hier ist der Jupiter mit Mond und Ring jedoch stilisiert, der Ring deutlich hervorgehoben, als wäre er massiv und permanent sichtbar. Bilder die Objekte im All zeigen sind für uns oft weniger greifbar, weil wir oft keine genaue Vorstellung haben, wie so etwas tatsächlich aussehen sollte. Doch genau deshalb lohnt es sich auch hier genau hinzuschauen."},
            {"bild": "Bilder_Spiel/bobbitwurm.jpg", "kategorie": "A", "erklaerung": "Das ist ein Riesenborstenwurm, auch Bobbitwurm (<i>Eunice aphroditois</i>) genannt. Er lebt im Sand von tropischen Gewässer und kann bis zu 3 m lang werden."},
            {"bild": "Bilder_Spiel/fake_cat.jpeg", "kategorie": "B", "erklaerung": 'Das ist ein von KI erstelltes Bild. Fast könnte man denken, es sei einfach ein stark bearbeitetes Webefoto, vielleicht für Katzenfutter oder Raumduft...Wer genau hinschaut erkennt jedoch, dass dieser Katze einige "Schnurrhaare" (Vibrissen) fehlen - vor allem auf ihrer linken Stirn.'},
            {"bild": "Bilder_Spiel/costasiella1.jpg", "kategorie": "A", "erklaerung": "Dieses Foto zeigt ein sogenanntes Blattschaf (<i>Costasiella kuroshimae</i>) Es handelt sich um eine Meeresschnecke, die vor allem  in den Gewässern rund um Japan, Indonesien und den Philippinen gefunden wurde. Da sie jedoch nur zwischen 4 und 10 mm groß ist, wird sie wohl auch häufig übersehen. Die blattartigen Körperanhänge (Cerata) der Schnecke haben zwei Funktionen: <br>1. Sie vergrößern die Körperoberfläche, was bei Hautatmern wie Schnecken für eine bessere Sauerstoffaufnahme sorgt. <br>2. Sie bieten Platz um darin unzählige Chloplasten einzulagern, die durch die Ernährung von Algen aufgenommen werden. Die Chloroplasten werden durch die Verdauung nicht zerstört, und können durch die transparente Haut der Schnecke hindurch Licht aufnehmen. So kann die Schecke, obwohl sie ein Tier ist Photosynthese betreiben und kann es sich dadurch leisten weniger zu fressen."},
            {"bild": "Bilder_Spiel/dragonhead.jpg", "kategorie": "A", "erklaerung": "Dies ist die Raupe des Common Nawab (<i>Polyura athamas</i>) , eines Schmetterlings dessen Verbreitungsgebiet etwa von Indien bis Indonesien reicht. "},
            {"bild": "Bilder_Spiel/fake_libelle.jpeg", "kategorie": "B", "erklaerung": "Dies ist ein KI-Bild. Mal abgesehen davon, das es wie eine Nahaufnahme in perfektem Licht aussehen soll, fehlt dieser angeblichen Libelle ein Flügel. Zudem sehen die Tropfen auf den Flügeln etwas zu perfekt, viel zu groß und einzeln verteilt aus. Von den Farben her ähnelt diese KI-Libelle am ehesten einem Männchen der Gebänderten Prachtlibelle (<i>Calopteryx splendens</i>), die man auch in Norddeutschland vor allem zwischen Juni und August beobachten kann."},
            {"bild": "Bilder_Spiel/fake_wolves.jpeg", "kategorie": "B", "erklaerung": "Das ist ein KI-Bild. Hier sind es vor allem die Schauze und die Beine die etwas Seltsames an sich haben. Auch das Licht und der aufgewirbelte Schnee sehen unnatürlich aus. Es ist ein typisches Beispiel für ein Desktop-Hintergrundbild mit Tieren. Auch wenn noch vor wenigen Jahren solche Bilder hauptsächlich von Menschen künstlich erstellt wurden, häuft sich heute ein unendlich großer Datenberg von individuellen KI-Hintergundbildern, KI-Profilbildern etc."},
            {"bild": "Bilder_Spiel/echidna.jpg", "kategorie": "A", "erklaerung": "Dies ist ein Kurzschnabel-Ameisenigel (Short beaked echidna - <i>Tachyglossus aculeatus</i>).  Auch wenn es ein bisschen  wie ein Niffler aus der Harry Potter Welt aussieht, lebt dieses Tier tatsächlich in Australien, Tasmanien und Neuguinea. Zusammen mit den drei Arten der Langschnabel-Ameisenigel und dem Schnabeltier sind sie die einzigen Säugetiere, die Eier legen. "},
            {"bild": "Bilder_Spiel/fake_playtpus.jpeg", "kategorie": "B", "erklaerung": "Dies ist ein KI-Bild. KI Bilder, die eine Szene Unterwasser zeigen, sehen heute häufig noch aus, als wären sie eigentlich Überwasser aufgenommen worden, da es keine Störung im Bild durch Wasser gibt. Die Luftblasen in diesem Bild sind stilisiert angeordnet, es gibt wieder ein perfektes Licht, das Fell perfekt, hell und wirkt nur leicht nass. Der Schnabel wirkt fast wie aus Plastik oder Leder auf dieses perfekte Fell aufgesetzt, die Augen sind gläsern und sehen aus wie bei einem Kuscheltier.."},
            {"bild": "Bilder_Spiel/fake_reh.png", "kategorie": "B", "erklaerung": "Dieses Bild ist KI generiert - allerdings ziemlich gut. Proportionen und Färbung des Rehs sind sehr gut getroffen, auch die Umgebung scheint realistisch. Wer genau hinschaut erkennt leichte Unebenheiten in der Fellstruktur, und eventuell eine leichte Fehlstellung der Beine, doch das ist wirklich schwierig auszumachen."},
            {"bild": "Bilder_Spiel/gerenuk.jpeg", "kategorie": "A", "erklaerung": "Das ist ein Gerenuk, auch Giraffengazelle (<i>Litocranius sp.</i>) genannt. Sie ist in Westafrika in Tansania, Äthiopien, Somalia und Kenia verbreitet, wo sie trockene Dornenbuschlanschaften bewohnt. <br> Ihre Schulterhöhe beträgt etwa 1 m."},
            {"bild": "Bilder_Spiel/fake_fossil.png", "kategorie": "B", "erklaerung": "Dies ist ein KI Bild einer angeblichen Ausgrabungsstätte. Mal abgesehen davon, dass es keine Einhörner gibt oder, so weit wir wissen je gegeben hat, deutet auch der Rest des Bildes eindeutig auf KI hin: Düsteres, mysteriöses Licht; eine perfekt ausgehobene Grube und ein perfekt geborgene Skelett mit einer daneben liegenden Skala, die man nicht erkennen kann."},
            {"bild": "Bilder_Spiel/fake_squid.png", "kategorie": "B", "erklaerung": 'Dies ist ein KI Bild. Und auch wenn darüber steht: <br> „Diese Foto ist echt und wurde heute aufgenommen"<br> ...Nein, es ist nicht echt. Warum? <br> 1. Die Körperform deutet zunächst auf einen Kraken d.h. Oktopus hin. Es wurden aber bisher keine Oktopoden gefunden, die diese Größe erreichen. Der größte Oktopus, den wir heute kennen ist der Pazifische Riesenoktopus (<i>Enteroctopus dofleini</i>), der ausgesteckt etwa 5 m lang werden kann, während ein Einzelfall von etwa 9 m berichtet. Hier muss man jedoch beachten, dass der Körper von Oktopoden sehr flexibel und dehnbar ist, aber nicht unendlich viel Masse besitzt. Wenn ein Oktopus seine Arme ausstreckt, bis es nicht mehr geht, wird er deshalb unweigerlich immer dünner, während der KI-Krake trotz seiner Länge sehr kompakt aussieht. Auch die extreme Größe des Riesenkalmars (<i>Architeuthis dux</i>) basiert vor allem auf ihren zwei einzelnen verlängerten Tentakeln , durch die die Körperlänge auf bis zu 13 m summiert werden kann. Jedoch ist auf diesem Bild kein Kalmar zu sehen. <br> 2. Was machen die Menschen da im Hintergrund? Warum sind da Leute im Wasser? Sollen das Surfer sein? Warum sind da nicht mehr Menschen…?'},
            {"bild": "Bilder_Spiel/glaucus.jpg", "kategorie": "A", "erklaerung": "Dies ist ein echter Blauer Drache (<i>Glaucus atlanticus</i>). Ein anderer, etwas eindeutigerer, Name für dieses Tier ist Blaue Ozeanschnecke, denn ja bei diesem winzigen, ca 3 cm großen 'Drachen' handelt es sich um eine Schnecke, die im offenen Ozean, an der Meeresoberfläche auf dem Rücken treibend, auf Beutezug nach Quallen geht. Man findet sie im temperaten bis tropischen Atlantik und Indischem Ozean, wo sie durch Strömungen auch an Küsten angeschwemmt werden können. Anfassen sollte man diese Schnecke jedoch nicht, da sie wie ihre Verwandte, das Blattschaf, ebenfalls Bestandteile ihrer Beute in sich aufnimmt, die in diesem Fall jedoch die auf der nackten Haut brennenden Nesselzellen (Cniden) der Quallen sind. "},
            {"bild": "Bilder_Spiel/lamprey.jpg", "kategorie": "A", "erklaerung": "Dies ist ein Meerneunauge (<i>Petromyzon marinus</i>). Mit ihrem kieferlosen Maul heften sie sich an Fische wie Kabeljau oder Lachs, um deren Haut und Muskelgewebe anzuraspeln und Blut zu saugen. Sie sind keine Fische, wandern aber wie viele Fische Flüsse hoch, um dort zu laichen. In den Flüssen leben sie mehrere Jahre und wandern dann zurück ins Meer, wo sie erwachsen werden, um zum Laichen wieder in ihren Fluss zurückzukehren."},
            {"bild": "Bilder_Spiel/fake_motte.png", "kategorie": "B", "erklaerung": "Das ist ein KI-Bild. Leider ebenfalls ein extrem Lebensechtes. Die Fühler sind etwas übertrieben groß und schön geschwungen, doch das Fehlen eines Saugrüssels ist erstmal nicht auffällig, da dieser auch eingerollt und verborgen sein kann. Trotzdem brauchen wir keine KI um eine solche pastell-feengleiche Motte zu erfinden, da es sie bereits gibt. Zum Beispiel die Rosy Maple Moth (<i>Dryocampa rubicunda</i>), die in Nordamerika beheimatet ist."},
            ...
            {"bild": "Bilder_Spiel/fake_pinguin.png", "kategorie": "B", "erklaerung": "Das ist KI Bild. <br> Es soll eine Frau (evtl. eine Forscherin, Tierpflegerin, Tierärztin oder Aktivistin) und ein Pinguinküken zeigen.  <br> Ein Kontakt, der in Realität so nicht stattfinden würde. <br> Pinguin-Arten stehen unter Naturschutz. <br> Kontakt zu Menschen unterliegt strengen Richtlinien, weshalb vor allem die Küken (wie bei allen Wildtieren), selbst bei Untersuchungen so wenig wie möglich von Menschen berührt werden sollten. <br> Umarmungen, die uns als Menschen liebevoll und tröstend erscheinen, bedeuten für Wildtiere puren Stress."},
            {"bild": "Bilder_Spiel/muntjac.jpg", "kategorie": "A", "erklaerung": "Das ist ein Chinesisches Muntjac (<i>Muntiacus reevesi</i>). <br> Die Öffnung unter den Augen sind kein Fehler einer KI, sondern zwei von vielen spezielle Drüsen, die dem Muntjac helfen seinen Geruch zu verbreiten. "},
            {"bild": "Bilder_Spiel/springspinne.jpg", "kategorie": "A", "erklaerung": "Erklärung folgt"},
            {"bild": "Bilder_Spiel/fake_relief.png", "kategorie": "B", "erklaerung": "KI erstelltes Bild eines Reliefs. <br> Es zeigt eine fiktionale Szene in der ein Alien-Gott-König zu sehen ist. <br> Bilder wie diese werden häufig in der Pseudo-Archäologie verwendet, verbunden mit gängigen Verschwörungstheorien. <br> Verschwörungstheoretiker*innen behaupten z.B. dass Menschen nicht in der Lage wären Steinblöcke glatt zu schneiden. <br> Das könnten angeblich nur Laser, was heißt, dass Gebäude und Monumente mit geheimer Alien-Technologie erbaut wurden. <br>Das ist eine Lüge. <br>Menschen in der Antike hatten handwerkliche Fähigkeiten und Wissen, von dem die meisten von uns heute nur träumen können. <br> Im Laufe der Zeit und durch die Erfindung von Maschinen sind uns viel Wissen und viele Fähigkeiten verloren gegangen."},
            {"bild": "Bilder_Spiel/stargazer.jpg", "kategorie": "A", "erklaerung": "Erklärung folgt"},
            {"bild": "Bilder_Spiel/spiderweb.png", "kategorie": "A", "erklaerung": "Tatsächlich ist dies trotz des reißerischen Textes wahr. Die Bilder sind echte Aufnahmen einer Forschungsgruppe."},
            ]
