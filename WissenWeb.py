...
# Bildpfad, Kategorie, Erklärung
        spiel_bilder = [
            ...
            {"bild": "Bilder_Spiel/barreleyefish.png", "kategorie": "A", "erklaerung": "Glaskopffisch (Macropinna microstoma). Lebt im nördlichen Pazifik und hat eine Länge von etwa 11 cm."},
            {"bild": "Bilder_Spiel/fake_seaserpent.png", "kategorie": "B", "erklaerung": "Das ist ein von KI erstelltes Bild. Das erkennt man nicht nur daran, dass es solche riesigen drachenartigen Seeschlangen nicht gibt, sondern auch an der Markellosigkeit des Bildes. Oben wird in einer seltsamen Perspektive ein Lichtspiel auf einer Wasseroberfläche imitiert, das jedoch keine Auswirkungen auf das Licht Unterwasser zu haben scheint. Die tauchende Person scheint m Atemluft auszustoßen, das Seeungeheuer jedoch nicht. Im Hintergrund wird ein Felsen angedeutet, ansonsten sieht das Ganze jedoch aus, als fände die Szene im offenen Ozean statt."},
            ...
            {"bild": "Bilder_Spiel/batfish.jpg", "kategorie": "A", "erklaerung": "Das ist ein Fisch, der Rotlippige Seefledermaus (Ogcocephalus darwini) genannt wird. Man findet sie in der Umgebung der Galápagos Inseln. Sie gehören zu den sehr interessanten Ordnung der Armflosser (Lophiiformes) von denen viele tatsächlich mit ihren Flossen über den Meeresboden laufen statt zu schwimmen. Zudem ist der erste Hartstrahl der Rückenflosse meist zu einer Art „Angel" umgebildet."},
            ...
            {"bild": "Bilder_Spiel/bobbitwurm.jpg", "kategorie": "A", "erklaerung": "Das ist ein Riesenborstenwurm, auch Bobbitwurm (Eunice aphroditois) genannt. Er lebt im Sand von tropischen Gewässer und kann bis zu 3 m lang werden."},
            ...
            {"bild": "Bilder_Spiel/gerenuk.jpeg", "kategorie": "A", "erklaerung": "Das ist ein Gerenuk, auch Giraffengazelle (Litocranius sp.) genannt. Sie ist in Westafrika in Tansania, Äthiopien, Somalia und Kenia verbreitet, wo sie trockene Dornenbuschlanschaften bewohnt. Ihre Schulterhöhe beträgt etwa 1 m."},
            ...
            {"bild": "Bilder_Spiel/fake_squid.png", "kategorie": "B", "erklaerung": 'Dies ist ein KI Bild. Und auch wenn darüber steht: „Diese Foto ist echt und wurde heute aufgenommen" - nein, es ist nicht echt. Warum? 1. Die Körperform deutet zunächst auf einen Kraken d.h. Oktopus hin. Es wurden aber bisher keine Oktopoden gefunden, die diese Größe erreichen. Der größte Oktopus, den wir heute kennen ist der Pazifische Riesenoktopus (Enteroctopus dofleini), der ausgesteckt etwa 5 m lang werden kann, während ein Einzelfall von etwa 9 m berichtet. Hier muss man jedoch beachten, dass der Körper von Oktopoden sehr flexibel und dehnbar ist, aber nicht unendlich viel Masse besitzt. Wenn ein Oktopus seine Arme ausstreckt bis es nicht mehr geht, wird er deshalb unweigerlich immer dünner. Auch Riesenkalmare erreicht gerade mal eine Körperlänge von etwa 5 m. Es werden jedoch bei Kalmaren immer auch ihre zwei verlängerten Tentakel gemessen, durch die die Körperlänge auf bis zu 13 m anwächst. Jedoch ist dies kein Kalmar. <br> 2. Was machen die Menschen da im Hintergrund? Warum sind da Leute im Wasser? Sollen das Surfer sein? Warum sind da nicht mehr Menschen…?'},
            {"bild": "Bilder_Spiel/glaucus.jpg", "kategorie": "A", "erklaerung": "Dies ist ein echter Blauer Drache (Glaucus atlanticus). Ein anderer, etwas eindeutigerer, Name für dieses Tier ist Blaue Ozeanschnecke, denn ja bei diesem winzigen, ca 3 cm großen „Drachen" handelt es sich um eine Schnecke, die im offenen Ozean, an der Meeresoberfläche auf dem Rücken treibend, auf Beutezug nach Quallen geht. Man findet sie im temperaten bis tropischen Atlantik und Indischem Ozean, wo sie durch Strömungen auch an Küsten angeschwemmt werden können. Anfassen sollte man diese Schnecke jedoch nicht, da sie wie ihre Verwandte, das Blattschaf, ebenfalls Bestandteile ihrer Beute in sich aufnimmt, die in diesem Fall jedoch die auf der nackten Haut brennenden Nesselzellen (Cniden) der Quallen sind. "},
            {"bild": "Bilder_Spiel/lamprey.jpg", "kategorie": "A", "erklaerung": "Dies ist ein Meerneunauge (Petromyzon marinus). Mit ihrem kieferlosen Maul heften sie sich an Fische wie Kabeljau oder Lachs, um deren Haut und Muskelgewebe anzuraspeln und Blut zu saugen. Sie sind keine Fische, wandern aber wie viele Fische Flüsse hoch, um dort zu laichen. In den Flüssen leben sie mehrere Jahre und wandern dann zurück ins Meer, wo sie erwachsen werden, um zum Laichen wieder in ihren Fluss zurückzukehren."},
