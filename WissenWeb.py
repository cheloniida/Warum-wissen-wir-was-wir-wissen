...
# Bildpfad, Kategorie, Erklärung
        spiel_bilder = [
            ...
            {"bild": "Bilder_Spiel/batfish.jpg", "kategorie": "A", "erklaerung": "Das ist ein Fisch, der Rotlippige Seefledermaus (<i>Ogcocephalus darwini</i>) genannt wird. Man findet sie in der Umgebung der Galápagos Inseln. Sie gehören zu den sehr interessanten Ordnung der Armflosser (<i>Lophiiformes</i>) von denen viele tatsächlich mit ihren Flossen über den Meeresboden laufen können. Zudem ist der erste Hartstrahl der Rückenflosse meist zu einer Art 'Angel' umgebildet."},
